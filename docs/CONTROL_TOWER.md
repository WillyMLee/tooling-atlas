...
- A four-module eval pilot with twelve reproducible agent scenarios and a quality-gated scorer.
...
3. Run the twelve stable pilot scenarios in `evals/pilot-suite.json` as matched pairs.
